...
if("TRUE" STREQUAL "TRUE")
  set(poscmd_2_odom_SOURCE_PREFIX /home/yyf/EGO-Planner-v2/swarm-playground/main_ws/src/uav_simulator/fake_drone)
  set(poscmd_2_odom_DEVEL_PREFIX /home/yyf/EGO-Planner-v2/swarm-playground/main_ws/devel)
  ...
  set(poscmd_2_odom_INSTALL_PREFIX /home/yyf/EGO-Planner-v2/swarm-playground/main_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'poscmd_2_odom' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yyf/EGO-Planner-v2/swarm-playground/main_ws/src/uav_simulator/fake_drone/${idir}'.  ${_report}")
    endif()
